...
var sPreviousTip= sSharedCHM + "Previous topic";
var sNextTip= sSharedCHM + "Next topic";
var sExpandTip= sSharedCHM + "Expand/collapse";
var sPopupTip= sSharedCHM + "View definition";
var sShortcutTip= sSharedCHM + "";
...
function EncodeID(topic_id) {
  ...
  else if (topic_id=="IDH_GEOGRAPHIC") topic_id = "A set of coordinates (expressed in terms of Latitude and Longitude) representing a point on the earth's surface in relation to the equator and Greenwich meridian respectively.";  
